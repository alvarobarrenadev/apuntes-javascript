...
npm install`},{paso:"4. Iniciar Servidor",descripcion:"Arrancar el entorno de desarrollo.",codigo:"npm run dev"}],nota:"Vite se encarga de servir tus módulos, recargar la página automáticamente (HMR) y optimizar el código para producción."}]}]},d={1:i,2:s,3:t,4:c,5:l};function n(e){return d[e]||null}function u(e,o){const a=n(e);return a&&a.clases.find(r=>r.id===o)||null}function m(e){const o=n(e);return o?o.clases:[]}export{u as a,m as g};
