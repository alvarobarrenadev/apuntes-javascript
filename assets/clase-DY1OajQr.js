import{c as nt,i as no,a as ao,b as ro,g as lo}from"./search-0qNoTBfR.js";function co(e,t){const o=document.getElementById("lessonContainer");if(!o)return;const s=nt(e,t);if(!s){o.innerHTML='<p class="error">Clase no encontrada</p>';return}o.innerHTML=`
