import{i as t,a}from"./footer-BfRR1JS6.js";import{g as o}from"./index-CHveRH_F.js";t();a();const r=document.querySelector("main"),c=parseInt(r?.dataset.modulo||"1",10);d(c);function d(s){const i=document.getElementById("classesGrid");if(!i)return;const n=o(s);if(n.length===0){i.innerHTML="<p>No hay clases disponibles</p>";return}i.innerHTML=n.map(e=>`
